...
class Database:
    ...
    def create_tables(self) -> bool:
        ...
        try:
            ...
            print("✓ Tất cả bảng đã được tạo (bao gồm registration_period & teachers)")
            return True
        except Error as e:
...
if __name__ == "__main__":
    ...
    # Kiểm tra 9 bảng (THÊM registration_period & teachers)
    try:
        cursor = db.connection.cursor()
        expected_tables = ['users', 'students', 'teachers', 'classes', 'class_enrollments', 
                          'sessions', 'attendance', 'email_logs', 'registration_period']
        cursor.execute("""
        ...
        if not missing:
            print("✓ Kiểm tra: Tất cả 9 bảng đã tồn tại:")
